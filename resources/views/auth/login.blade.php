...
<body class="min-h-screen flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full max-w-md space-y-6">
        ...
        <div class="text-center">
            ...
            <p class="mt-1 text-sm text-slate-500">Silakan masuk menggunakan email atau akun Google Anda</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-teal-950/5 space-y-5">
            ...
            @if(session('success'))
                <div class="p-3.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-medium">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <a href="{{ route('auth.google') }}"
               class="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl border-2 border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 text-slate-800 font-bold text-sm transition-all shadow-sm group">
