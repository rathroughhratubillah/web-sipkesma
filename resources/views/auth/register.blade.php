    ...
    <div class="w-full max-w-md space-y-6">
        ...
        <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-teal-950/5 space-y-5">
            ...
            <a href="{{ route('auth.google') }}"
               class="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl border-2 border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 text-slate-800 font-bold text-sm transition-all shadow-sm">
            ...
            <div class="relative flex items-center gap-3">
                ...
                <span class="text-xs text-slate-400 font-medium">atau daftar dengan email</span>
                <div class="flex-1 h-px bg-slate-100"></div>
            </div>
